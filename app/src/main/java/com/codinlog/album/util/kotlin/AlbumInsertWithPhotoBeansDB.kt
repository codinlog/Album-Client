...
class AlbumInsertWithPhotoBeansDB(albumDAO: AlbumDAO, albumItemDAO: AlbumItemDAO, albumEntity: AlbumEntity, commonListener: CommonListener) : AsyncTask<AlbumItemEntity, Unit, List<Long>>() {
