...
class AlbumItemQueryByAlbumIdDB(private val albumItemDAO: AlbumItemDAO, private val commonListener: CommonListener) : AsyncTask<Int, Unit, List<AlbumItemEntity>>() {
